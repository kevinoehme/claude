...
**Nicht** auto-lesen: `architecture.drawio` (~1-4 k Tokens XML pro Session). Nur on-demand laden, wenn die Aufgabe strukturelle Architektur-Änderungen betrifft (neuer/entfernter MCP-Server, neuer Agent, geänderter Datenfluss) — siehe Architektur-Pflege-Regel unten. Für reine Tool-Inhaltsfragen reicht CLAUDE.md.
